...
from llm_aggregator.models import FilesSizeGathererConfig, Model
...
async def gather_files_size(model: Model) -> int | None:
    ...
    try:
        ...
        return await _gather_custom(cfg, model.id)
...
async def _gather_custom(cfg: FilesSizeGathererConfig, model_id: str) -> int | None:
    ...
    if not script_path.exists():
        ...
        return None
    cmd = [str(script_path), cfg.base_path, model_id]
